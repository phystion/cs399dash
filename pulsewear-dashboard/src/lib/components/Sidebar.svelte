...
<aside class="sidebar" class:expanded aria-label="Main navigation">
  ...
  <!-- Account area -->
  <div class="logo-area">
    <div class="account-avatar">EB</div>
    <div class="account-info">
      <span class="account-label">Your Account</span>
      <span class="account-name">Ethan Brooks</span>
    </div>
  </div>
  ...
  <nav class="sidebar-nav" aria-label="Pages">
    ...
    <a href="/recommendations"
      class="nav-item"
      class:active={$page.url.pathname.startsWith('/recommendations')}
    ...
    <a href="/analysis"
      class="nav-item"
      class:active={$page.url.pathname.startsWith('/analysis')}
    ...
    <a href="/sentiment"
      class="nav-item"
      class:active={$page.url.pathname.startsWith('/sentiment')}
    ...
    <a href="/trends"
      class="nav-item"
      class:active={$page.url.pathname.startsWith('/trends')}
      data-tooltip="Trends"
      aria-label="Trends"
    >
      <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    <a href="/roadmap"
      class="nav-item"
      class:active={$page.url.pathname.startsWith('/roadmap')}
    ...
    >
      <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
           stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        <path d="M21 11.5a8.5 8.5 0 0 1-8.5 8.5c-1.7 0-3.29-.5-4.62-1.35L3 20l1.35-4.88A8.46 8.46 0 0 1 3.5 11.5 8.5 8.5 0 1 1 21 11.5z"/>
      </svg>
    ...
    >
      <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
           stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        <path d="M12 2a10 10 0 0 1 7.39 16.74L21 22l-3.26-1.61A10 10 0 1 1 12 2z"/>
...
<style>
  ...
  .sidebar.expanded .account-avatar {
    width: 52px;
    height: 52px;
    font-size: 0.82rem;
  }
  ...
  .account-info {
    ...
    overflow: hidden;
    pointer-events: none;
    transition: opacity 0.18s ease 0.1s, max-height 0.26s ease;
  }
  ...
  .nav-item.active .nav-icon { stroke-width: 2.2; }
  ...
  .nav-label {
    ...
    overflow: hidden;
    pointer-events: none;
    transition: opacity 0.16s ease, max-width 0.26s cubic-bezier(0.4, 0, 0.2, 1);
  }
  ...
  /* Hide tooltips when labels are visible */
  .sidebar.expanded .nav-item[data-tooltip]::after {
    display: none;
  }

  /* Tooltip via ::after (collapsed only) */
